...
function ContactSection() {
  return (
    <section id="contact" className="contact-section">
      ...
      <div className="contact-details"><a href="tel:+917829154715" data-testid="link-phone"><Phone size={15} />+91 7829154715</a><span className="contact-divider" /><a className="resume-download" href={`${import.meta.env.BASE_URL}akshitha-shetty-resume.pdf`} download="Akshitha-Shetty-Resume.pdf" data-testid="link-contact-resume"><Download size={15} />Resume PDF</a><a href="https://github.com/akshithashetty982-blip" target="_blank" rel="noreferrer" data-testid="link-github"><Github size={15} />GitHub <ExternalLink size={12} /></a><a href="https://www.linkedin.com/in/akshitha-shetty-01a1a2284" target="_blank" rel="noreferrer" data-testid="link-linkedin"><Linkedin size={15} />LinkedIn <ExternalLink size={12} /></a></div>
    </section>
  );
}
